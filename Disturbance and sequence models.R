...
alphamodel <- chlmodel <- stan_lmer(formula = Alpha ~ Seq + + Disturb + Time + (1 | repli), 
...
Ekmodel <- chlmodel <- stan_lmer(formula = Ek ~ Seq + + Disturb + Time + (1 | repli), 
...
Ekmodel <- chlmodel <- stan_lmer(formula = rETRmax ~ Seq * Disturb + Time + (1 | repli), 
...
Fv/Fmmodel <- chlmodel <- stan_lmer(formula = Fv.Fm ~ Seq + + Disturb + Time + (1 | repli), 
